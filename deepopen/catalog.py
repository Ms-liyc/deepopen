...
AST_AND_ANALYZER_META: tuple[dict[str, object], ...] = (
    ...
    {"rule_id": "AST070", "title": "标准库 XML 解析", "severity": "medium", "category": "security", "cwe": "CWE-611"},
    {"rule_id": "AST071", "title": "跳转目标来自请求", "severity": "high", "category": "security", "cwe": "CWE-601"},
    {"rule_id": "AST072", "title": "删除路径由字符串拼接得到", "severity": "high", "category": "security", "cwe": "CWE-22"},
    {"rule_id": "AST073", "title": "pickle.Unpickler", "severity": "high", "category": "security", "cwe": "CWE-502"},
    {"rule_id": "AST074", "title": "按变量动态导入模块", "severity": "high", "category": "security", "cwe": "CWE-95"},
    {"rule_id": "AST075", "title": "用常量给随机数播种", "severity": "medium", "category": "security", "cwe": "CWE-330"},
    {"rule_id": "AST076", "title": "Popen 未约束等待时间", "severity": "medium", "category": "bug", "cwe": "CWE-400"},
    {"rule_id": "AST077", "title": "关闭 TLS 主机名或证书校验", "severity": "high", "category": "security", "cwe": "CWE-295"},
    {"rule_id": "AST078", "title": "从 pickle 类格式读取数据", "severity": "high", "category": "security", "cwe": "CWE-502"},
    {"rule_id": "AST079", "title": "明文邮件/新闻协议", "severity": "medium", "category": "security", "cwe": "CWE-319"},
    {"rule_id": "AST080", "title": "SSH 自动信任未知主机密钥", "severity": "high", "category": "security", "cwe": "CWE-295"},
    {"rule_id": "AST081", "title": "关闭 urllib3 的安全警告", "severity": "medium", "category": "security", "cwe": "CWE-295"},
    {"rule_id": "AST082", "title": "PBKDF2 迭代次数过低", "severity": "medium", "category": "security", "cwe": "CWE-916"},
    {"rule_id": "AST083", "title": "模板关闭自动转义", "severity": "high", "category": "security", "cwe": "CWE-79"},
